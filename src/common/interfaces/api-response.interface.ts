...
export const API_SUCCESS_RESPONSE_SCHEMA = {
  ...
  properties: {
    ...
    data: {
      description:
        'Тело ответа: объект сущности, массив или примитив в зависимости от эндпоинта. Нет единого типа.',
    },
    message: {
      type: 'string',
      nullable: true,
...
export const API_ERROR_RESPONSE_SCHEMA = {
  ...
  properties: {
    ...
    code: {
      type: 'string',
      description:
        'Машинный код ошибки: VALIDATION_ERROR, BAD_REQUEST, UNAUTHORIZED, FORBIDDEN, NOT_FOUND, CONFLICT, INTERNAL_ERROR',
    ...
    conflict: {
      type: 'object',
      description:
        'При 409: тип и данные конфликта (CLASSROOM_OCCUPIED / TEACHER_OCCUPIED, scheduleId, scheduleDate, lessonNumber)',
      properties: {
